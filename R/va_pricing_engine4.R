...
#' Variable Annuity pricing engine with general financial processes and
#' Weibull mortality
#' @description
...
#' of mortality is determinitic and given by the Weibull function.
...
va_sde_engine2 <- R6::R6Class("va_sde_engine2", inherit = va_engine,
 public = list(
  initialize = function(product, financial_parms, c1, c2){
