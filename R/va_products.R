...
#Three public methods will return the times of survival benifit payments, death
#benefit payment if any and the possible surrender times depending on the time of
#death.
##########################DESIGN COMMENTS END###################################
