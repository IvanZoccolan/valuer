...
Valuer aims at pricing a type of life insurance contract called variable annuity.
...
It's written using [R6](https://CRAN.R-project.org/package=R6) and comes with classes which describe the variable annuity contracts and other classes, called pricing engines, which are used to price those contracts.  
...
###Release status###
[![CRAN_Status_Badge](http://www.r-pkg.org/badges/version/valuer)](https://cran.r-project.org/package=valuer)  
